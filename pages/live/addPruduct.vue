<template>
	<view>
		<view>
			<view class="flexbetween">
				<view class="positionr padding1 box_col_85">
					<image style="width: 20px;height: 20px;position: absolute;left:20px;top:30rpx" src='../../static/search.svg'></image>
			...
			<view>
				<wfalls ref='allProduct' :list='list' v-if='list.length>0' @eventChecked="check"></wfalls>
			</view>
		...
		<view class="action-section">
			<view class="complete-btn" @click="addProduct">
				添加
			</view>
		</view>
...
<script>
	import wfalls from 'components/wfalls-flow/wfalls-flow'
	export default {
		components: {
			wfalls
		},
